...
public class MainDetailActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tbDetailHotel = findViewById(R.id.toolbar);
        ...
        if (modelHotel != null) {
            ...
            tbDetailHotel.setTitle(modelHotel.getTxtNamaHotel());
